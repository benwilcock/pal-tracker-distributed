...
@Configuration
@ConditionalOnProperty(value = "application.oauth-enabled", matchIfMissing = true) // will tell Spring to only load this config when application.oauth-enabled is either set to true or is not set.
